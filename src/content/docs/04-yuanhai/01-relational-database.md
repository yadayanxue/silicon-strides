...
| 概念 | 关联 |
|----------|------|
| B+Tree 页分裂 | [ext4 磁盘布局：inode 与 extent 树](../../03-qiankun/03-filesystem/#ext4-磁盘布局inode-与-extent-树) |
| WAL 预写日志 | [ext4 磁盘布局：inode 与 extent 树](../../03-qiankun/03-filesystem/#ext4-磁盘布局inode-与-extent-树) |

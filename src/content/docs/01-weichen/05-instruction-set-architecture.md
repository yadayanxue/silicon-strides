...
:::tip[跨卷连接：ARM 与嵌入式]
Cortex-M 的 [中断向量表与 NVIC](../../02-jiezi/01-bare-metal-programming/) 是卷二《芥子》裸机编程的硬件基础——32 个优先级、6 周期中断延迟的设计直接影响了 FreeRTOS 等 RTOS 的调度策略。
:::
...
- **卷二 · 芥子**：RISC-V 的 M-mode 和 Core-Local Interrupt Controller 是 [裸机中断处理](../../02-jiezi/01-bare-metal-programming/) 的硬件基础。

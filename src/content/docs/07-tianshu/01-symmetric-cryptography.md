...
| 概念 | 关联 |
|---------|---------|
| AES S-Box $GF(2^8)$ | [有限域：AES 的代数舞台](../../00-lingxi/06-cryptographic-mathematics/#有限域aes-的代数舞台) |
| GCM GHASH | [$GF(2^{128})$ 多项式乘法](../../00-lingxi/06-cryptographic-mathematics/) |
| AES-NI | [CISC 与 RISC：两套哲学的五十年对决](../../01-weichen/05-instruction-set-architecture/#cisc-与-risc两套哲学的五十年对决) |

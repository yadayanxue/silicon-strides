...
> 最后更新：2026-06-20 · 八卷四十九章 100%，13 章深度改进 + 审查修正
...
| KaTeX `$$` 覆盖 | ✅ 36/49 | 3 章于 2026-06-20 补充（算法理论 + 体系结构 + 计算理论） |
| 内容无歧义 | ✅ | 概念表述清晰准确，无矛盾 |
...
| 卷零 · 灵犀 | 816 | 136 | ⭐⭐ 精炼有质 | 算法理论 + 计算理论章深度补充 |
...
| # | 章节 | 原行数 | 新行数 | 新增 KaTeX | 新增亮点 |
|---|------|:--:|:--:|------|------|
| 0.3 | 计算理论 | 113 | 165 | 5 条 $$ | 图灵机七元组 $\delta$ 转移函数 + RE/Recursive 区分 + P/NP 形式化定义 + 多项式时间归约 $\leq_p$ + Chomsky 严格包含链 |
...
精炼有质 ████████████████████         卷零 127、卷四 115、卷八 119、卷六 127
```
...
| 🟡 中 | 同步原语 | `03-qiankun/04-synchronization.md` | 313 | Amdahl 加速比 + RCU 宽限期 + 死锁 Banker 算法 |
